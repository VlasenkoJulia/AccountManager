...
public class AccountEntityControllerTest {
    ...
    private final ClientDto client = getClientDto(1);

    private final AccountDto accountDtoWithNotNullId = new AccountDto(1, "111", "840", "CURRENT", 1.0, "01.01.1970", 1);
    ...
    private final String ACCOUNT_DTO_WITH_NOT_NULL_ID_JSON = "{\n"
            ...
            + "  \"ownerId\": 1\n"
            + "}";
    private final AccountDto accountDtoWithNullId = new AccountDto(null, "111", "840", "CURRENT", 1.0, "01.01.1970", 1);
    ...
    private ClientDto getClientDto(Integer id) {
