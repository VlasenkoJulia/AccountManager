...
public class UserEntityControllerTest {
    ...
    private UserEntity validUserEntity = createUser("username", "password", "password", "email@demo.com");
    ...
    private UserEntity invalidUserEntity = createUser("username", "password", "password", "email");
    ...
    public void createUser_InvalidUser_ShouldReturnErrorDto() throws Exception {
        when(userService.create(invalidUserEntity)).thenThrow(new InputParameterValidationException(EXCEPTION_MESSAGE));
    ...
    public void createUser_ValidUser_ShouldReturnSuccessMessage() throws Exception {
        when(userService.create(validUserEntity)).thenReturn("User created successfully! You can return to login page and log in!");
