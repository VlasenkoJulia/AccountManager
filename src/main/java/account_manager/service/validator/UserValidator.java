...
public class UserValidator {
    ...
    public void validateGetByEmail(User user) {
        if (user == null) {
            throw new InputParameterValidationException("User with passed email do not exist");
        }
    }

    public void validateGetByResetToken(User user) {
        if (user == null) {
    ...
    public void validateSetResetToken(User user) {
        if (user.getResetToken() == null) {
